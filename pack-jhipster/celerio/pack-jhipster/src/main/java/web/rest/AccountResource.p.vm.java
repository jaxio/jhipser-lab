$output.java("${Web.packageName}.rest", "AccountResource")##

import com.codahale.metrics.annotation.Timed;
import ${Model.packageName}.Authority;
import ${Model.packageName}.PersistentToken;
import ${Model.packageName}.User;
import ${Root.packageName}.repository.PersistentTokenRepository;
import ${Root.packageName}.repository.UserRepository;
import ${Root.packageName}.security.SecurityUtils;
import ${Root.packageName}.service.MailService;
import ${Root.packageName}.service.UserService;
import ${Root.packageName}.web.rest.dto.KeyAndPasswordDTO;
import ${Root.packageName}.web.rest.dto.ManagedUserDTO;
import ${Root.packageName}.web.rest.dto.UserDTO;
import ${Root.packageName}.web.rest.util.HeaderUtil;
