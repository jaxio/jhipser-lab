$output.java("${Web.packageName}.rest", "UserResource")##

import com.codahale.metrics.annotation.Timed;
import ${Model.packageName}.Authority;
import ${Model.packageName}.User;
import ${Root.packageName}.repository.AuthorityRepository;
import ${Root.packageName}.repository.UserRepository;
import ${Root.packageName}.security.AuthoritiesConstants;
...
import ${Root.packageName}.web.rest.util.PaginationUtil;
